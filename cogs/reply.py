    ...
    async def on_message(self, message: discord.Message):
        ...
        if self.bot.user in message.mentions:
            ...
            responses = [
                ...
                "Ta có thể bỏ qua cho ngươi lần này, nhưng nếu có lần sau, thì ta cũng bỏ qua. Heyzz, vẫn là lão Hùng ta lương thiện. 🙄",
                "Một con gà nướng, lão Hùng ta có thể bỏ qua cho ngươi lần này.",
                "Ngươi không lo đi tu luyện, đến lúc ra ngoài bị người khác bắt nạt thì đừng chạy về mách lão phu. 😒",
                "Tu chân giới vốn là nơi hiểm ác, lão phu chỉ hy vọng các ngươi không đánh mất sơ tâm. 😇",
                "Có lão phu ở đây, trời sập thì có người trên gánh, mấy tiểu tử các ngươi cứ an tâm mà tu luyện đi. 🤠",
